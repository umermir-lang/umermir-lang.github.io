(function(){const s=document.createElement("link").relList;if(s&&s.supports&&s.supports("modulepreload"))return;for(const t of document.querySelectorAll('link[rel="modulepreload"]'))u(t);new MutationObserver(t=>{for(const l of t)if(l.type==="childList")for(const n of l.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&u(n)}).observe(document,{childList:!0,subtree:!0});function o(t){const l={};return t.integrity&&(l.integrity=t.integrity),t.referrerPolicy&&(l.referrerPolicy=t.referrerPolicy),t.crossOrigin==="use-credentials"?l.credentials="include":t.crossOrigin==="anonymous"?l.credentials="omit":l.credentials="same-origin",l}function u(t){if(t.ep)return;t.ep=!0;const l=o(t);fetch(t.href,l)}})();const p=[{title:"AI-Powered Change Management",html:`
        ...
        `},{title:"The Problem: Manual Management is Broken",html:`
        ...
        `},{title:"Unlocking Value You Already Own",html:`
        ...
        `},{title:"Industry-Specific Challenges",html:`
        ...
        `},{title:"Case Study: Manufacturing Risk",html:`
        ...
        `},{title:"The Solution: AI at Every Stage",html:`
        ...
        `},{title:"Intelligent Request Handling",html:`
            <div class="grid grid-cols-1 md:grid-cols-2 gap-16 h-full items-center">
        ...
        `},{title:"Streamlined Approvals & Documentation",html:`
            <div class="grid grid-cols-1 md:grid-cols-2 gap-16 h-full items-center">
        ...
        `},{title:"End-to-End SDLC Integration",html:`
        ...
        `},{title:"Business Value & Immediate ROI",html:`
        ...
        `}];let i=0;const a=p.length,d=document.getElementById("slide-content"),m=document.getElementById("header-slide-title"),w=document.getElementById("top-progress-bar"),y=document.getElementById("progress-percent"),k=document.getElementById("slide-index-label"),h=document.getElementById("nav-dots"),v=document.getElementById("nav-next"),g=document.getElementById("nav-prev"),b=document.getElementById("hitbox-left"),f=document.getElementById("hitbox-right");function I(){h.innerHTML="";for(let e=0;e<a;e++){const s=document.createElement("button");s.className=`h-2 rounded-full transition-all duration-500 ${e===i?"bg-blue-600 w-8":"bg-slate-300 w-2 hover:bg-slate-400"}`,s.onclick=()=>A(e),h.appendChild(s)}}function r(e){d.classList.remove("slide-visible"),d.classList.add("slide-hidden"),setTimeout(()=>{i=e;const s=p[e];d.innerHTML=s.html,m.textContent=s.title;const o=Math.round((e+1)/a*100);w.style.width=`${o}%`,y.textContent=`${o}%`,k.textContent=`${String(e+1).padStart(2,"0")} / ${a}`,g.disabled=e===0,v.disabled=e===a-1,b.disabled=e===0,f.disabled=e===a-1,I(),lucide.createIcons(),d.classList.remove("slide-hidden"),d.classList.add("slide-visible")},400)}function c(){i<a-1&&r(i+1)}function x(){i>0&&r(i-1)}function A(e){e!==i&&r(e)}v.onclick=c;g.onclick=x;b.onclick=x;f.onclick=c;window.addEventListener("keydown",e=>{(e.key==="ArrowRight"||e.key===" ")&&c(),e.key==="ArrowLeft"&&x()});r(0);
